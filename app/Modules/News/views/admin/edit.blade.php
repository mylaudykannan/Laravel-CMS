...
@push('stylesheets')
    ...
    @section('content')
        <div class="container-fluid" id="editdiv">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ URL('admin/news/update?lang=' . app()->getLocale()) }}" method="post"
                        id="newsform">
                        @csrf
                            ...
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div
                                    ...
                                    <a href="{{ URL('admin/news/add') }}"
                                        class="btn btn-default mb-0 mr-3 btn-sm text-white">ADD NEW NEWS</a>
                                </div>
                            </div>
                                                        ...
                                                        <tbody>
                                                            @if (
                                                                ...
                                                                <tr id="{{ $k }}addr0" data-id="0"
                                                                    class="@if (!config('news.section.' . $slug . '.' . $k . '.static')) hidden novalidation @endif ">
                                                                    <td data-name="stitle">
                                                                        @if (isset($v['blade']))
                                                                            @include(
                                                                                'News::admin.section.' .
                                                            ...
                                                            @if (isset($newssections[$k]))
                                                                @foreach ($newssections[$k] as $sk => $sv)
                                                                    <tr id="{{ $k }}addr{{ $sk + 1 }}"
                                                                        ...
                                                                        @if (!config('news.section.' . $slug . '.' . $k . '.static'))
                                                                            <td data-name="del"><a
                                                                                    href="{{ URL('admin/news/sectiondelete/' . $sv['id']) }}"
                                                                                    name="{{ $k }}del{{ $sk + 1 }}"
                                                                                    class="btn btn-danger row-remove"><i
